...
- ☐ **기능명세서 작성** - 테이블 형태로 대분류/요구사항ID/기능명/설명/담당자(FE/BE) 명세
- ☐ **와이어 프레임** - 레이아웃 이해를 위한 와이어 프레임 그리기
- ☐ **시스템 아키텍처 구조도** - 흐름 파악 및 파이프라인 구조 이해를 위한 아키텍처 설계
- ☐ **ERD** - Database 설계를 위한 초기 구조 구상
