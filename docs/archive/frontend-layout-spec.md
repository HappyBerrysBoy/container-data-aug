...
- `frontend/src/app/page.tsx`: page entry
- `frontend/src/app/layout.tsx`: metadata and root layout
- `frontend/src/components/app-shell.tsx`: sidebar/main shell and screen state
- `frontend/src/components/project-sidebar.tsx`: collapsible project sidebar
- `frontend/src/components/views/empty-project-view.tsx`: initial screen
- `frontend/src/components/views/create-project-view.tsx`: project creation form
- `frontend/src/components/views/project-detail-view.tsx`: project detail screen
- `frontend/src/types/project.ts`: project data type
